...
- ⚠️ **IMPORTANT FOR FUTURE**: Always create a feature branch and PR instead of pushing directly to main!
- Story was incorrectly pushed directly to main - should have created `feat/story-3.1-latest-spot-home` branch and PR
